...
//  Subclass
//
//  Created by 韩倩云 on 2022/9/14.
//  Copyright © 2022 yy. All rights reserved.
//

import UIKit

class HHKeyChain: NSObject {
    ...
    // TODO: 存储数据
    @discardableResult //解决调用方法 没实现返回值的警告 Result of call to 'keyChainSaveData(data:withIdentifier:)' is unused
